        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex flex-col gap-2.5 text-sm text-slate-400">
              ...
              <a href="https://oeh.jku.at" target="_blank" rel="noopener noreferrer" data-testid="footer-oeh" className="hover:text-blue-500 transition-colors flex items-center gap-2">
                <ExternalLink size={14}/>oeh.jku.at
              </a>
            </div>
          </div>
        </div>
