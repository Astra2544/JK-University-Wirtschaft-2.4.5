/**
 * ═══════════════════════════════════════════════════════════════════════════
 *  ADMIN LVA SECTION | ÖH Wirtschaft Website
 *  LVA (Lehrveranstaltungen) Management
 * ═══════════════════════════════════════════════════════════════════════════
 */
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-slate-900">LVA-Verwaltung</h2>
        <div className="flex items-center gap-3">
          <button
            onClick={handleImport}
            disabled={importing}
            data-testid="import-lvas-btn"
            className="flex items-center gap-2 px-4 py-2.5 bg-green-500 hover:bg-green-600 disabled:bg-green-300 text-white rounded-xl text-sm font-medium"
          >
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
          ...
          <p className="text-2xl font-bold text-blue-700">{lvas.length}</p>
        </div>
        <div className="bg-green-50 border border-green-100 rounded-xl p-4">
          <p className="text-green-600 text-sm font-medium">Aktiv</p>
          <p className="text-2xl font-bold text-green-700">{lvas.filter(l => l.is_active).length}</p>
        </div>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
          <p className="text-slate-600 text-sm font-medium">Inaktiv</p>
          <p className="text-2xl font-bold text-slate-700">{lvas.filter(l => !l.is_active).length}</p>
        </div>
      </div>
