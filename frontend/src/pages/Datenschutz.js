/**
 * ═══════════════════════════════════════════════════════════════════════════
 *  DATENSCHUTZ PAGE | ÖH Wirtschaft Website
 * ═══════════════════════════════════════════════════════════════════════════
 */
      ...
      <section data-testid="datenschutz-hero" className="relative pt-28 pb-16 md:pt-36 md:pb-20 px-5 overflow-hidden">
        ...
        <div className="max-w-[800px] mx-auto relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.6 }}
            ...
            <span className="text-sm text-slate-500 font-medium">Rechtliches</span>
          </motion.div>
              ...
              <div className="prose prose-slate max-w-none">
                <div className="space-y-6 text-slate-600 leading-relaxed">
                  <p>
                    ...
                    der Hochschüler_innenschaft an der JKU (ÖH JKU) kooperieren bzw. Teil deren Infrastruktur 
                    sind, gilt für unser Angebot die zentrale Datenschutzerklärung der ÖH JKU.
                  </p>
                  ...
                  <div className="pt-4 border-t border-slate-100">
                    <p className="text-sm text-slate-500 italic">
                      <strong>Hinweis:</strong> Durch die Nutzung dieser Website erklärst du dich mit der 
                      Datenverarbeitung gemäß der oben verlinkten Richtlinie einverstanden.
                    </p>
                  </div>
                </div>
              </div>
